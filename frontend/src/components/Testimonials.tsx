...
const generateTestimonialsHTML = (design: string, color: string): string => {
  if (design === "Design1") {
    return `
  <main id="testimonials" class="relative z-10 px-4 py-12 sm:py-24 md:px-12 md:py-32 lg:py-36 xl:px-16 xl:py-48">
 ...
 <section id="testimonials"
    class="relative z-10 px-4 py-12 sm:py-24 md:px-12 md:py-32 lg:py-36 xl:px-16 xl:py-48">
